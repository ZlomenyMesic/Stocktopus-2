...
namespace Stocktopus_2 {
    internal static class ValueTables {
        ...
        public static int GetValue(Piece piece, int i, int numberOfPieces) {
            i = piece.color == Color.White ? i : 64 - i;
            short[] valueTables = numberOfPieces > 12 ? MidgameTables : EndgameTables;

            switch (piece.pieceType) {
                case PieceType.Pawn: return valueTables[64 - i];
                case PieceType.Knight: return valueTables[(2 * 64) - i];
                case PieceType.Bishop: return valueTables[(3 * 64) - i];
                case PieceType.Rook: return valueTables[(4 * 64) - i];
                case PieceType.Queen: return valueTables[(5 * 64) - i];
                case PieceType.King: return valueTables[(6 * 64) - i];
            }
